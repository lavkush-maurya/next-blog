...
export function SnippetCard({ snippet }: { snippet: SnippetFrontMatter }) {
  ...
  return (
    <Link href={`/snippets/${slug}`} title={title}>
      <div className="mb-4 flex h-full cursor-pointer rounded border border-gray-300 hover:border-gray-500 dark:border-gray-600 dark:hover:border-gray-400 lg:mb-0">

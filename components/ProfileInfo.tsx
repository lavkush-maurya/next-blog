...
export function ProfileCardInfo() {
  return (
    <div className="hidden py-4 xl:block xl:px-6">
      <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Lavkush Maurya</h3>
      <h5 className="py-2 text-gray-700 dark:text-gray-400">Learner | Developer</h5>

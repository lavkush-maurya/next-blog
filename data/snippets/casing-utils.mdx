...
> Learn how to safely rename a case-sensitive file or directory in a Git repository: [Case sensitive renaming](/snippets/rename-a-case-sensitive-file-in-a-git-repo)

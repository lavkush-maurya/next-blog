...
<Twemoji emoji="light-bulb" /> I would highly recommend adding a `postinstall` script in the **package.json** file to automatically install husky hooks after installing dependencies:

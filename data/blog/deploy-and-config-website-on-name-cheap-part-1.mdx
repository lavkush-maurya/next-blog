...
## Để có 1 site hoàn chỉnh cần những gì?leohuynh.dev
...
- **Domain name** <Twemoji emoji="magnifying-glass-tilted-right" />: là địa chỉ website của mình, vd: _[pondhub.com](http://www.thepondhub.com/)_, _[](https://leohuynh.dev)_ ... Có thể hiểu đây như là địa chỉ nhà của mình, thay cho địa chỉ ip giúp ng khác dễ dàng tìm kiếm.
